...
public class SearchResponseTest {
  ...
  public void createSearchResponseShouldReturnAResult() throws Exception {
    ...
    assertEquals(
        "total number of results", (int) response.getResponse().getTotalNumberOfResults(), 301);
  ...
  public void createSearchResponseShouldReturnAResultWithVariations() throws Exception {
    ...
    assertEquals(
        ...
        response.getResponse().getResults().get(0).getVariations().get(0).getData().getImageUrl(),
    ...
    assertTrue(
        ...
        response.getResponse().getResults().get(0).getVariations().get(0).getData().getMetadata()
            != null);
    assertEquals(
    ...
    assertEquals(
        ...
        "411.25");
    assertEquals(
        "total number of results", (int) response.getResponse().getTotalNumberOfResults(), 261);
    assertTrue(
  ...
  public void createSearchResponseShouldReturnAResultWithSortOptions() throws Exception {
    ...
    SearchResponse response = ConstructorIO.createSearchResponse(string);
    assertEquals(
        "search result [sort options] exists", response.getResponse().getSortOptions().size(), 1);
    assertEquals(
