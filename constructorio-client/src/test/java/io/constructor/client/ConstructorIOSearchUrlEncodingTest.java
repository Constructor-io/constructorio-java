...
public class ConstructorIOSearchUrlEncodingTest {
    ...
    public void SearchWithPlusShouldBeEncodedInUrl() throws Exception {
        ...
        String expectedPath = "/search/r%2Bco?key=key_K2hlXt5aVSwoI1Uw&c=ciojava-5.4.0&section=Products&page=1&num_results_per_page=30";
    ...
    public void SearchWithSpaceShouldBeEncodedInUrl() throws Exception {
        ...
        RecordedRequest recordedRequest = mockServer.takeRequest();
        String expectedPath = "/search/r%20co?key=key_K2hlXt5aVSwoI1Uw&c=ciojava-5.4.0&section=Products&page=1&num_results_per_page=30";
        String actualPath = recordedRequest.getPath();
        assertEquals("recorded request is encoded correctly", actualPath, expectedPath);
    }
    ...
    public void SearchWithSlashShouldBeEncodedInUrl() throws Exception {
        ...
        RecordedRequest recordedRequest = mockServer.takeRequest();
        String expectedPath = "/search/r%2Fco?key=key_K2hlXt5aVSwoI1Uw&c=ciojava-5.4.0&section=Products&page=1&num_results_per_page=30";
        String actualPath = recordedRequest.getPath();
        assertEquals("recorded request is encoded correctly", actualPath, expectedPath);
    }
    ...
    public void SearchWithSingleQuoteShouldBeAllowedInUrl() throws Exception {
        ...
        RecordedRequest recordedRequest = mockServer.takeRequest();
        String expectedPath = "/search/r'co?key=key_K2hlXt5aVSwoI1Uw&c=ciojava-5.4.0&section=Products&page=1&num_results_per_page=30";
        String actualPath = recordedRequest.getPath();
        assertEquals("recorded request is encoded correctly", actualPath, expectedPath);
    }
}