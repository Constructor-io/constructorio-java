...
/** Constructor.io base Search/Browse Request */
public class BrowseSearchBaseRequest {
    ...
    /**
     * Object with common request fields of search and browse
     *
     */
    public BrowseSearchBaseRequest() {
    ...
    /**
     * @param filterMatchTypes the filterMatchTypes to set. Please refer to the relevant Search/Browse API endpoint documentation for details.
