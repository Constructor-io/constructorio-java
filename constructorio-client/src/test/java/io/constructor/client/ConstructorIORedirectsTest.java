...
public class ConstructorIORedirectsTest {
    ...
    public void AllRedirectsAsJsonShouldReturnAResult() throws Exception {
        ...
        AllRedirectsResponse response = new Gson().fromJson(stringResponse, AllRedirectsResponse.class);
    ...
    @Test
    public void AllRedirectsShouldReturnAResultWhenPageAndResultsPerPageArePassed() throws Exception {
        ConstructorIO constructor = new ConstructorIO(apiToken, apiKey, true, null);
        AllRedirectsRequest request = new AllRedirectsRequest();
        request.setPage(3);
    ...
    @Test
    public void AllRedirectsAsJsonShouldReturnAResultWhenPageAndResultsPerPageArePassed() throws Exception {
        ConstructorIO constructor = new ConstructorIO(apiToken, apiKey, true, null);
        AllRedirectsRequest request = new AllRedirectsRequest();
        request.setPage(3);
        request.setResultsPerPage(100);
    ...
    @Test
    public void AllRedirectsShouldReturnAResultWhenOffsetAndResultsPerPageArePassed() throws Exception {
        ConstructorIO constructor = new ConstructorIO(apiToken, apiKey, true, null);
        AllRedirectsRequest request = new AllRedirectsRequest();
    ...
    @Test
    public void AllRedirectsAsJsonShouldReturnAResultWhenOffsetAndResultsPerPageArePassed() throws Exception {
        ConstructorIO constructor = new ConstructorIO(apiToken, apiKey, true, null);
        AllRedirectsRequest request = new AllRedirectsRequest();
        request.setOffset(100);
        request.setResultsPerPage(100);
    ...
    public void AllRedirectsShouldReturnAResultWhenQueryIsPassed() throws Exception {
        ...
        assertTrue("Redirect matches query", response.getRedirectRules().get(0).getMatches().get(0).getPattern().equals("another rickroll"));
