...
public class QuizResultsResponseTest {
    ...
    public void createQuizResultsResponseShouldReturnAResult() throws Exception {
        ...
        assertEquals("quiz_version_id exists", "8298dc03-e7eb-4ce8-8c6f-6315c900b5e8", response.getQuizVersionId());
        assertEquals("quiz_session_id exists", "bf2f9b65-84bf-492a-bad1-66ffd07f9448", response.getQuizSessionId());
        ...
        assertTrue("response total num results exist", response.getResponse().getTotalNumberOfResults() > 0);
