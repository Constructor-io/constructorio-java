...
public class QuizRequest {
  ...
  public QuizRequest(String id) {
    if (id == null) throw new IllegalArgumentException("id is a required parameter of type String");
  ...
  /**
   * @param answers the list of answers in the format [ [1,2], [3,4] ] where [1,2] are the selected
   *     answers for the first question and [3,4] are the selected answers for the second question
   */
